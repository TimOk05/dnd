...
- ✅ **Убраны английские надписи** - все переведено на русский язык
- ✅ **Исправлена фильтрация сложности** - добавлены монстры разных CR
- ✅ **Добавлена опция "Любой тип"** - можно не выбирать тип противника
- ✅ **Исправлена генерация персонажей** - создан новый API generate-characters.php
- ✅ **Расширен список противников** - добавлено 25+ новых монстров с разными CR
- ✅ **Исправлена фильтрация типов** - теперь корректно работает выбор типа существ
