...
function formatNpcBlocks(txt, forcedName = '') {
    ...
    if (trait && /служит|академи|обучает|преподает|мастерская|мешок|инструменты|станок|разбирает|носит|мечтает|стать|известным|советником|влияния|события/i.test(trait)) {
