...
const systemInstruction = 'Сгенерируй NPC для DnD. Строго по шаблону: Имя: ... Краткое описание: ... Черта характера: ... Слабость: ... Короткая характеристика: ... Описание: ... Внешность: ... Особенности поведения: ... Обязательно заполни все блоки: Имя, Краткое описание, Черта характера, Слабость, Короткая характеристика. Не оставляй их пустыми. Если не можешь заполнить остальные блоки — не выводи их.';
...
function formatNpcBlocks(txt, forcedName = '') {
    ...
    if (requiredBlocks.some(b => !b || b.trim() === '')) {
