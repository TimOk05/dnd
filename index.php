...
function fetchNpcFromAI(race, npcClass, prof, level) {
    ...
    fetch('pdf/d100_unique_traders.json')
      ...
      .then(json => {
        ...
        const systemInstruction = 'Создавай NPC в следующем строгом формате без лишних символов:\n\nИмя и Профессия\n[Полное имя и профессия персонажа]\n\nОписание\n[Подробное описание персонажа, его мотивации, целей, прошлого - 3-4 предложения]\n\nВнешность\n[Детальное описание внешнего вида, одежды, аксессуаров - 2-3 предложения]\n\nЧерты характера\n[Личностные качества и особенности поведения - 1-2 предложения]\n\nТехнические параметры\nОружие: [название оружия]\nУрон: [формат урона, например 1d6 рубящий]\nХиты: [количество хитов]\n\nВАЖНО: Используй ТОЛЬКО эти заголовки. НЕ добавляй лишние символы, кавычки или форматирование. Каждый блок должен содержать только релевантную информацию. Делай NPC детальными и интересными!';
