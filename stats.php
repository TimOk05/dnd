...
<head>
    ...
    <style>
        ...
        .stats-container {
            max-width: 800px;
            margin: 0 auto;
            background: var(--bg-secondary) url('https://www.transparenttextures.com/patterns/old-paper.png');
            border-radius: 10px;
        ...
        .stat-card {
            background: var(--bg-tertiary) url('https://www.transparenttextures.com/patterns/old-paper.png');
            padding: 20px;
            border-radius: 8px;
            text-align: center;
