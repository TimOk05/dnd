...
require_once 'hybrid-npc-generator.php';
...
// Инициализируем гибридный генератор
...
try {
    // Генерируем NPC с использованием гибридного подхода
    $npcData = $hybridGenerator->generateHybridNPC([
        'race' => $race,
        'class' => $class,
        'level' => $level,
        'alignment' => $alignment,
    ...
    $result = [
        ...
        'api_used' => $npcData['api_source'] ?? 'Hybrid System',
        'ai_enhanced' => $npcData['ai_enhanced'] ?? false
    ];
