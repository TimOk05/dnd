...
class CharacterGenerator {
    ...
    private function getNamesByRace($race, $gender = 'random') {
        $names = [
            ...
            'tabaxi' => [
                'male' => ['Мяурик', 'Когтист', 'Пятнистый', 'Полосатый', 'Рыжий', 'Черный', 'Белый', 'Серый', 'Рык', 'Мур'],
                'female' => ['Мяура', 'Когтица', 'Пятнистая', 'Полосатая', 'Рыжая', 'Черная', 'Белая', 'Серая', 'Рычащая', 'Мурчащая']
            ],
            'aarakocra' => [
