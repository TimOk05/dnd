...
class CharacterGenerator {
    ...
    private function getNamesByRace($race, $gender = 'random') {
        $names = [
            ...
            'tabaxi' => [
                'male' => ['Когтист', 'Пятнистый', 'Полосатый', 'Рыжий', 'Черный', 'Белый', 'Серый', 'Рык', 'Мур', 'Мяу'],
                'female' => ['Когтица', 'Пятнистая', 'Полосатая', 'Рыжая', 'Черная', 'Белая', 'Серая', 'Рычащая', 'Мурчащая', 'Мяукающая']
            ],
            'aarakocra' => [
                'male' => ['Крыло', 'Перо', 'Клюв', 'Когтистый', 'Высокий', 'Быстрый', 'Ветреный', 'Облачный', 'Небесный', 'Орлиный'],
                'female' => ['Крылья', 'Перья', 'Клювица', 'Когтистая', 'Высокая', 'Быстрая', 'Ветреная', 'Облачная', 'Небесная', 'Орлиная']
            ],
            'goblin' => [
                'male' => ['Нос', 'Ухо', 'Глаз', 'Зуб', 'Коготь', 'Хвост', 'Лапа', 'Клык', 'Коготок', 'Хвостик'],
                'female' => ['Носик', 'Ушко', 'Глазок', 'Зубик', 'Коготок', 'Хвостик', 'Лапка', 'Клычок', 'Коготок', 'Хвостик']
            ],
            'kenku' => [
                'male' => ['Эхо', 'Крик', 'Шепот', 'Голос', 'Звук', 'Шум', 'Тишина', 'Молчание', 'Речь', 'Слово'],
                'female' => ['Эхо', 'Крик', 'Шепот', 'Голос', 'Звук', 'Шум', 'Тишина', 'Молчание', 'Речь', 'Слово']
            ],
            'lizardfolk' => [
                'male' => ['Чешуя', 'Хвост', 'Клык', 'Коготь', 'Змеиный', 'Ящер', 'Рептилия', 'Хладнокровный', 'Чешуйчатый', 'Хвостатый'],
                'female' => ['Чешуя', 'Хвост', 'Клык', 'Коготь', 'Змеиная', 'Ящерица', 'Рептилия', 'Хладнокровная', 'Чешуйчатая', 'Хвостатая']
            ],
            'triton' => [
                'male' => ['Волна', 'Пена', 'Море', 'Океан', 'Рыба', 'Водный', 'Морской', 'Глубинный', 'Приливный', 'Отливный'],
                'female' => ['Волна', 'Пена', 'Море', 'Океан', 'Рыба', 'Водная', 'Морская', 'Глубинная', 'Приливная', 'Отливная']
            ],
            'yuan-ti' => [
                'male' => ['Змей', 'Кобра', 'Гадюка', 'Аспид', 'Питон', 'Удав', 'Мамба', 'Королевская', 'Императорская', 'Божественная'],
                'female' => ['Змея', 'Кобра', 'Гадюка', 'Аспид', 'Питон', 'Удав', 'Мамба', 'Королевская', 'Императорская', 'Божественная']
            ],
            'goliath' => [
                'male' => ['Камень', 'Скала', 'Гора', 'Утес', 'Кремень', 'Гранит', 'Базальт', 'Мрамор', 'Известняк', 'Песчаник'],
                'female' => ['Камень', 'Скала', 'Гора', 'Утес', 'Кремень', 'Гранит', 'Базальт', 'Мрамор', 'Известняк', 'Песчаник']
            ],
            'firbolg' => [
                'male' => ['Дуб', 'Сосна', 'Береза', 'Кедр', 'Клен', 'Вяз', 'Ясень', 'Липа', 'Осина', 'Рябина'],
                'female' => ['Дуб', 'Сосна', 'Береза', 'Кедр', 'Клен', 'Вяз', 'Ясень', 'Липа', 'Осина', 'Рябина']
            ],
            'bugbear' => [
                'male' => ['Медведь', 'Бурый', 'Белый', 'Черный', 'Рыжий', 'Косолапый', 'Мохнатый', 'Когтистый', 'Рычащий', 'Грозный'],
                'female' => ['Медведица', 'Бурая', 'Белая', 'Черная', 'Рыжая', 'Косолапая', 'Мохнатая', 'Когтистая', 'Рычащая', 'Грозная']
            ],
            'hobgoblin' => [
                'male' => ['Гоблин', 'Вождь', 'Полководец', 'Генерал', 'Капитан', 'Сержант', 'Рядовой', 'Офицер', 'Командир', 'Воин'],
                'female' => ['Гоблин', 'Вождь', 'Полководец', 'Генерал', 'Капитан', 'Сержант', 'Рядовой', 'Офицер', 'Командир', 'Воин']
            ],
            'kobold' => [
                'male' => ['Кобольд', 'Маленький', 'Быстрый', 'Хитрый', 'Ловкий', 'Проворный', 'Юркий', 'Шустрый', 'Резвый', 'Бойкий'],
                'female' => ['Кобольд', 'Маленькая', 'Быстрая', 'Хитрая', 'Ловкая', 'Проворная', 'Юркая', 'Шустрая', 'Резвая', 'Бойкая']
            ]
        ];
